...
'This script include functinality of completing the all type of Engegements.'
...
try {
    WebUI.waitForElementPresent(findTestObject('Sign-Offs_FinalReview_Object/Proceed_BTN_Completion'), 0, FailureHandling.STOP_ON_FAILURE)
...
try {
    WebUI.waitForElementPresent(findTestObject('Sign-Offs_FinalReview_Object/Proceed_BTN_Completion'), 0, FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.click(findTestObject('Sign-Offs_FinalReview_Object/Proceed_BTN_Completion'), FailureHandling.CONTINUE_ON_FAILURE)
}
catch (Exception e) {
    println('All the Benchmarks are Completed')
} 
