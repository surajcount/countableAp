...
WebUI.click(findTestObject('Letters/Letters Template/Firm-Folder-2ndFolder'))
...
WebUI.setText(findTestObject('Letters/Letters Template/Firm-Kebab-Rename-TextField'), 'renamed folder')

WebUI.click(findTestObject('Letters/Letters Template/Firm-Kebab-Rename-EDIT Section-TextField - Save'))

WebUI.verifyTextPresent('Template folder renamed successfully', false)

WebUI.click(findTestObject('Letters/Letters Template/Firm-Folder-2ndFolder'))

WebUI.click(findTestObject('Letters/Letters Template/FirmTemplate-SubFolder-KebabMenu - Delete'))
