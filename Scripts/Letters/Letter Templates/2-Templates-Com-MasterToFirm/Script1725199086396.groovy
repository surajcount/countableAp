...
//===================<<MANAGEMENT LETTER>>>=================================================================
WebUI.click(findTestObject('Letters/Letters Template/Canada COM Management responsibility acknowledgement CSRS 4200'))

WebUI.verifyTextPresent('Management responsibility & acknowledgement CSRS 4200', false)

String comMLLetter = WebUI.getText(findTestObject('Letters/Letters Template/Templates-Letters-Com'))

println('--------Actual Letter------------------')

println('Actual Management Letter Data: ' + comMLLetter)

// Define the multi-line text block
String mlcomcontent=""" Header goes here
Date
...
First Name
,
Further to our engagement letter dated Date , you acknowledge that you are responsible for:
a. The compiled financial information;
...
If you have any questions about the contents of this letter, please raise them with us. Please sign and return the attached copy of this letter to indicate your acknowledgment of, and agreement with, your responsibilities for the compilation engagement.
...
println('Expected Management Letter Data: ' + mlcomcontent)

if (comMLLetter.trim() == mlcomcontent.trim()) {
	println('Management Letter matching')
} else {
	println('Management Not matching')
}
