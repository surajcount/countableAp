...
WebUI.click(findTestObject('Letters/Letters Template/FirmTemplate-SubFolder-KebabMenu - Move'))

WebUI.click(findTestObject('Letters/Letters Template/Letters-Master-Copy-Existing-DropDown'))

'Add Selection in xpath'
...
WebUI.verifyTextPresent('Letter template is moved successfully', false)
