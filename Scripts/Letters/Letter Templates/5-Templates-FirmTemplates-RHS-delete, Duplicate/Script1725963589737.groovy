...
String rhsButtonFirmTemplate = editduplicateRHS

WebUI.setText(findTestObject('Letters/Letters Template/Letter-CreateNewFolder-FolderNameTextField'), rhsButtonFirmTemplate)

WebUI.click(findTestObject('Letters/Letters Template/Letters-CreateNewFolder-AddButton'))

WebUI.delay(5)

WebUI.click(findTestObject('Letters/Letters Template/FirmTemplate-DuplicateRHS Button'))
...
WebUI.click(findTestObject('Letters/Letters Template/Firm-RHSDuplicate-DuplicatePopup'))
...
WebUI.click(findTestObject('Letters/Letters Template/FirmTemplate-DeleteRHS Button'))

WebUI.verifyTextPresent('Letter(s) deleted successfully', false)
