...
String clientEntityNameLetter = clientEntityNameLetter

WebUI.setText(findTestObject('Object Repository/client page/EntityName_mat-input-8'), clientEntityNameLetter)
...
String clientEmailIdLetter = clientEmailAddressLetter

WebUI.setText(findTestObject('Object Repository/client page/Client Email'), clientEmailIdLetter)
