...
WebUI.click(findTestObject('Object Repository/Page_UAT (Countable)/span_Add Client'))

WebUI.click(findTestObject('Object Repository/Page_UAT (Countable)/span_Upload Existing Clients'))

WebUI.sendKeys(findTestObject('client page/uploadFile'), 'C:\\Users\\admin\\Downloads\\AccountClientImport (9).csv')
