...
String clientSelection=clientSelectForGrouping
WebDriver driver = DriverFactory.getWebDriver()

WebElement clientSelect = driver.findElement(By.xpath("//td[@title='" + clientSelection + "']/following-sibling::td[3]"))
clientSelect.click()
//WebUI.click(findTestObject('workbook/TBGrouping/IntegrationButton TB Grouping'))
