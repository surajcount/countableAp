...
WebUI.click(findTestObject('TB Source/AdjEntry/JE2Checkbox'))

WebUI.click(findTestObject('TB Source/AdjEntry/ValidateAccountV'))

WebUI.click(findTestObject('TB Source/AdjEntry/ClickJEArea'))
...
WebUI.verifyTextPresent('Accounts Receivable (A/R): Account type is restricted for pushback entry', false)

WebUI.verifyTextPresent('Accounts Payable: Account type (CREDITORS/DEBTORS) is restricted for pushback entry in Xero', false)
