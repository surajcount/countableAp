...
WebUI.click(findTestObject('TB Source/AdjEntry/0.00OfFirstAccountOnTB'))

WebUI.click(findTestObject('TB Source/AdjEntry/JESelectionFromTBPage'))

WebUI.switchToWindowIndex(1)

WebUI.clearText(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/Account1Debit1'), 
...
WebUI.clearText(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/Account2credit2'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/Account2credit2'), 
    '10.10')
