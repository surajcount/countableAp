...
WebUI.click(findTestObject('TB CSV/TB Obj/TBCSVEdit and Delete/KebabDuplicate'))

WebUI.setText(findTestObject('Object Repository/Page_UAT (Countable)/input_Acc No_elem84'), '1234')

WebUI.setText(findTestObject('Object Repository/Page_UAT (Countable)/TB Description'), 'test@1234 duplicate')
