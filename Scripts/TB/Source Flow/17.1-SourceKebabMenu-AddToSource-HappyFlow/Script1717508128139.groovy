...
WebUI.setText(findTestObject('TB Source/UpdateToSourcePopupAccountCode'), '4567.9')

WebUI.setText(findTestObject('TB Source/UpdateToSourcePopupAccountDescription'), 'Automation4')

WebUI.click(findTestObject('TB Source/UpdateToSourcePopupAccountType'))

WebUI.click(findTestObject('TB Source/UpdateToSourcePopupAccountType-Current'))
