...
WebUI.click(findTestObject('AdjEntryRecordingProdIssue/Page_UAT (Countable)/2022-DecMonthSelection'))

WebUI.click(findTestObject('AdjEntryRecordingProdIssue/Page_UAT (Countable)/31stDec2022-dateSelection'))

WebUI.click(findTestObject('Object Repository/AdjEntryRecordingProdIssue/Page_UAT (Countable)/span_2021_1'))

WebUI.click(findTestObject('AdjEntryRecordingProdIssue/Page_UAT (Countable)/DatePickerApplyButton'))
...
WebUI.setText(findTestObject('Object Repository/AdjEntryRecordingProdIssue/Page_UAT (Countable)/textarea_Notes_mat-input-1'), 
    'enter upper fetched date here - 12/31/2022')

WebUI.click(findTestObject('Object Repository/AdjEntryRecordingProdIssue/Page_UAT (Countable)/span_Save'))

WebUI.switchToWindowIndex(1)

WebUI.click(findTestObject('AdjEntryRecordingProdIssue/Page_UAT (Countable)/AdjustingEntryLHS2022'))
...
WebUI.click(findTestObject('AdjEntryRecordingProdIssue/Page_UAT (Countable)/span_DEC 2022'))
...
WebUI.click(findTestObject('AdjEntryRecordingProdIssue/Page_UAT (Countable)/span_2022'))
...
WebUI.setText(findTestObject('Object Repository/AdjEntryRecordingProdIssue/Page_UAT (Countable)/textarea_Notes_mat-input-1'), 
    'enter upper fetched date here - 12/31/2022 >> to 3/1/2022')
