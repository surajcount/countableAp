...
WebUI.click(findTestObject('TB CSV/TB Obj/TBCSVEdit and Delete/span_Delete_kebab'))

WebUI.click(findTestObject('TB CSV/TB Obj/TBCSVEdit and Delete/span_Delete_mat-mdc-button-touch-target_popup'))

String toasterContainer = WebUI.getText(findTestObject('TB Source/ToasterContainer'))

String expectedToaster = 'Source connected records cannot be deleted.'

println('Actual ' + toasterContainer)

if (toasterContainer == expectedToaster) {
    println('Toaster message is correct')
} else {
