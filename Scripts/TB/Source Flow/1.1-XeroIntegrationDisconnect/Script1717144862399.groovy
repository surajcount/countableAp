...
WebUI.click(findTestObject('IntegrationOnClientPage/IntegrationWindowDisconnectSource'))

WebUI.click(findTestObject('IntegrationOnClientPage/IntegrationWindowDisconnectYesButton'))
