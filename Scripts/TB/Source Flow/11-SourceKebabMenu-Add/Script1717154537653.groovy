...
WebUI.setText(findTestObject('Object Repository/Page_UAT (Countable)/input_Acc No_elem84'), '1234.1')

WebUI.setText(findTestObject('Object Repository/Page_UAT (Countable)/TB Description'), 'Automation1')
