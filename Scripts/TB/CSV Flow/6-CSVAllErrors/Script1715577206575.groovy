...
//All Error Flow
WebUI.uploadFile(findTestObject('TB CSV/TB Obj/CSV Import'), 'C:\\Amol\\TB\\error\\all error.xlsx')
...
WebUI.click(findTestObject('TB CSV/TB Obj/CSVErrorObj/OkButton on popup'))
