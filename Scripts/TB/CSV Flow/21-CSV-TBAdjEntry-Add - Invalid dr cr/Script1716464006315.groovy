...
WebUI.click(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/Account2credit2'))

String abcd = WebUI.getText(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/Account1Debit1'))

println('debit value is ' + abcd)
...
WebUI.verifyElementNotClickable(findTestObject('Object Repository/TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-RECORD/span_Save'))
...
//String creditdifference = WebUI.getText(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/CreditDifference'))
//println('Credit Difference value is ' + creditdifference)
WebUI.verifyElementPresent(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/DebitDifference'), 
    10)

if (true) {
    String debitdifference = WebUI.getText(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/DebitDifference'))

    println('Debit Difference value is ' + debitdifference)

    //String debitamount= WebUI.verifyElementPresent(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/Account1Debit1'),10)
    String debitamount = WebUI.getText(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/Account1Debit1'))

    println('debit amount ' + debitamount)

    String updatedamount = debitamount + debitdifference

    println('Total is ' + updatedamount)

    WebUI.sendKeys(findTestObject('TB CSV/AdjustingEntryFlow/AdjustingEntryCSV/AdjEntryCSV-ADD-EDIT-DELETE-Manual/Account1Debit1'), 
        updatedamount)
